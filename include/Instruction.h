...
protected:
    ...
    enum {BINARY, COND, UNCOND, RET, LOAD, STORE, CMP, ALLOCA, CALL, XOR, ZEXT, ARRAY};
};
...
private:
    ...
    Operand* init;
public:
    ArrayInstruction(Operand* dst, Operand* arr, Operand* idx, BasicBlock* insert_bb = nullptr, bool isParam = false);
    ~ArrayInstruction();
    void output() const;
    void genMachineCode(AsmBuilder*);
